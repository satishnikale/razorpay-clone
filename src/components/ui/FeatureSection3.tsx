...
export const FeatureSection3 = () => {
    return <div className="w-[1080px] h-auto mx-auto">
        ...
        <div className="w-full grid grid-cols-3 gap-y-10 gap-x-4  relative z-10">
            {/* text-box*/}
                <div className="">
            ...
            {/* main box - 1 */}
                <div className="p-8 bg-[url(src/assets/images/instant-settlement-bg.svg)] w-full max-h-[500px] bg-no-repeat cursor-pointer
