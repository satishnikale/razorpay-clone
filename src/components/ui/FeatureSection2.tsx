...
export const FeatureSection2 = () => {
    return <div className="my-10">
        ...
        <div className="bg-[url(src/assets/images/feature-section-2BG.svg)] bg-cover bg-no-repeat h-auto pt-[16rem] pb-[500px]">
            ...
            <div className="w-[1080px] h-auto mx-auto relative z-10">
                ...
                <div className="h-[450px] border border-slate-700 rounded-md relative overflow-y-hidden">
                    ...
                    <img className="absolute right-0 top-0" src="src/assets/images/buisness-banking.png" alt="" />
                ...
                <div className="grid grid-cols-3 gap-4 my-14">
                    ...
                    <div className="w-full min-h-[15rem] relative cursor-pointer">
                        ...
                        <div className="z-[100] absolute w-full h-full flex flex-col justify-between pl-6 py-6 pr-8">
                            <div>
                                <h3 className="font-mullish font-bold text-white leading-[1.2] text-[1.375rem]">Subscriptions</h3>
                ...
                <div className="w-full h-32 flex justify-center items-center border border-gray-700 rounded px-10 space-y-2 gap-4">
